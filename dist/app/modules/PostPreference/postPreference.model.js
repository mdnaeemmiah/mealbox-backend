...
const PostPreferenceSchema = new mongoose_1.Schema({
...
const PostPreferenceModel = mongoose_1.default.model('PostPreference', PostPreferenceSchema);
exports.default = PostPreferenceModel;
