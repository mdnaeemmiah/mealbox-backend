...
const createOrder = (user, payload, client_ip) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const productDetails = yield Promise.all(payload.products.map((item) => __awaiter(void 0, void 0, void 0, function* () {
        const product = yield mealProvider_model_1.default.findById(item.product);
        if (!product) {
        ...
        if (typeof product.pricing !== "number" || isNaN(product.pricing)) {
            throw new AppError_1.default(http_status_1.default.INTERNAL_SERVER_ERROR, `Invalid pricing for product: ${product._id}`);
        }
